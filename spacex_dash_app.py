...
def get_pie_chart(entered_site):
    ...
    fig = px.pie(filtered_df, names='class', title=f'Success Count for {entered_site}')
    return fig
...
def update_scatter_chart(selected_site, selected_payload):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Payload vs. Class')
    return fig
